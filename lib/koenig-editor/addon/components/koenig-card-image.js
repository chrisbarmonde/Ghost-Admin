...
export default Component.extend({
    ...
    toolbar: computed('payload.{cardWidth,src}', function () {
        ...
        return {
            items: [{
                ...
                iconClass: `${cardWidth === 'left' ? 'fill-blue-l2' : 'fill-white'}`,
                width: 'left',
                ...
                title: 'Right',
                icon: 'koenig/kg-img-regular',
                iconClass: `${cardWidth === 'right' ? 'fill-blue-l2' : 'fill-white'}`,
                width: 'right',
                action: run.bind(this, this._changeCardWidth)
            }, {
                divider: true
    ...
    didRender() {
        ...
        const cardWidth = this.payload.cardWidth;
    ...
    _changeCardWidth(event) {
        const cardWidth = $(event.currentTarget).data('width') || '';
